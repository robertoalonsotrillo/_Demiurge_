...
1. [melgan](https://github.com/descriptinc/melgan-neurips) and [unagan](https://github.com/ciaua/unagan) will first process the audio files from a first database `RECORDED AUDIO DB` to produce GAN-generated that will be compiled in the `RAW GENERATED AUDIO DB`. 
